    ...
    >
      ...
      >
        <v-card-text>
          ...
          <div>
            <strong class="mb-3 d-inline-block">Mahardika Kessuma Denie</strong>
          </div>
          ...
          <v-btn
            ...
            rounded
            target="_blank"
            href="https:/facebook.com/mahardika.kessuma/"
          >
